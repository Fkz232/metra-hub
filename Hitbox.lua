...
local Window = Library:Create("Expansão De Hitbox")
...
HomeTab:InfoLabel("Funciona em alguns jogos.")
...
HomeTab:TextBox("Hitbox Transparente", function(number)
...
HomeTab:Toggle("Checar Time", function(state)
    getgenv().TeamCheck = state
end)

HomeTab:Keybind("Apertar UI", Enum.KeyCode.F, function()
    Library:ToggleUI()
end)
...
PlayerTab:Toggle("Loop Speed", function(state)
    getgenv().loopW = state
...
PlayerTab:Toggle("InfJump", function(s)
getgenv().InfJ = s
...
VisualTab:InfoLabel("Espere 3-10 segundos")

VisualTab:Toggle("Personagem Highlight", function(state)
