...
local function triggerBillboards()
	createBillboard(Vector3.new(-5, 0, 0), "... cursed technique amplification:, blue.       ...")
	createBillboard(Vector3.new(5, 0, 0), "...   cursed technique reversal:, red.")
end
...
local function attractNearbyParts()
	...
	local pullRadius = 500
	local pullForce = 9000000
